...
Purpose of program: Prints the dates and compares them. Then displays which comparison is true.
 Afterwards it compares the dates by subtracting them and displays how many hours between each date.
*/
